...
module.exports = function generateUnanswered (req, user, cb) {
    /* this will create an array of all of the questions that a user hasnt
     * answered to be stored in a session variable for directing the
     * questionnaire It EXCLUDES questions with order values higher than 1000,
     * which are reserved for conditional questions asked depending on responses
     * to others
    */
    ...
    Question.find({order: {$lt: 1000}}, 'order _id',
    {
      ...
      function(err, questions)
      {
        ...
        var unanswered = []
        User.findOne(user._id, 'answered', 
